...
**Подробно:**
- [docs/HOW-IT-WORKS.md](docs/HOW-IT-WORKS.md) — аналитика и скоринг: как всё работает сейчас (таблица этапов, честные ограничения) и что планируется — парсер офферов конкурентов (спека), TGStat, автофакт по UTM
...
- [content/segments/](content/segments/) — сегментные панели ЦА: [редакции](content/segments/editorial/panel.md) (на реальных данных канала) и [IT](content/segments/it-dev/panel.md), плюс `competitors.json` каждого сегмента
- [docs/COMPETITORS.md](docs/COMPETITORS.md) — конкурентный бенчмарк: кого считать конкурентом сегмента, методика снятия офферов (дословно, с датой и разметкой), цикл обновления; валидатор `node scripts/check-offers.mjs` (математика, свежесть 30 дней, покрытие каналов)
