...
### 4.4. Матрица «персона × пост»

Для каждой персоны аудитории канала — две оценки по шкале 0–10:
...
размеченных рекламных постов конкурентов — Битрикс24, YouGile, Weeek,
Яндекс Трекер, Shtab: **[scoring-dataset.md](scoring-dataset.md)** (каждый
пример — с разметкой, баллами и уроком, который он дал рубрике;
машиночитаемо — [scoring-dataset.json](scoring-dataset.json)).
Вот как это было по шагам.
