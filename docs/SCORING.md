...
данных канала (посты, комментарии, опросы аудитории). Каждая персона даёт
не только «достаёт/говорит», но и **прогноз действия** (пролистает, перешлёт,
кликнет, сохранит) — клик и пересылка это разные воронки. Операционный
пайплайн прогона со всеми этапами и гейтами: **[SCORING-PIPELINE.md](SCORING-PIPELINE.md)**.
