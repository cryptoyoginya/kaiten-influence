...
## Как посевы работают на закупку (v2.1)

Собранные посевы — не музей, а два боевых применения перед каждым сетом:

**1. Burn-check канала.** Перед генерацией сета (`/creo`, шаг 3.5) проверить
`creatives.json` сегмента: какие жанры и углы конкуренты выжгли в ЭТОМ канале
за последние 3–4 недели. Наш пост тем же жанром сразу после чужого читается
как «ещё одна реклама трекера» — жанр меняем, даже если он наш сильнейший.

**2. Карта незанятых углов (white space).** Свести углы всех посевов и офферов
сегмента в таблицу «кто про что говорит». Углы, где пусто, — наши кандидаты
в победители: там нет баннерной слепоты. Пример из практики: в it-dev все
конкуренты бьют в «замену Jira» и цену; про метрики потока и прогноз сроков
по процентилям — тишина → это и стало углом для pm_god. Результат карты —
раздел в `kb-angles.md` канала: «углы, свободные от конкурентов, на дату».
