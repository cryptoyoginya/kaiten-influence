...
def main():
    ...
    if SPRINT_SHEET in wb.sheetnames:
        ...
        STEPS = ["Креатив согл. Кайтен", "Креатив согл. автор", "Данные договора",
                 "Договор составлен", "Договор подписан", "Счёт оплачен",
                 "Маркировка готова", "Маркировка нанесена", "Опубликовано", "Аналитика"]
        for row in rows:
            name = clean(row[0]) if row else ""
